...
Image handling:
- For image replacement requests, use our semantic image endpoint: https://homenshop.net/api/img?q={english-keywords}&w={width}&h={height}
...
- Example full URL: https://homenshop.net/api/img?q=sky&w=1920&h=1080
- For background image: background-image: url(https://homenshop.net/api/img?q=sky&w=1920&h=1080)
- IMPORTANT: always use the absolute https://homenshop.net prefix — relative /api/img paths break on custom domains.
