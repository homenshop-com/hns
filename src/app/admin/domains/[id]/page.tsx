...
export default function AdminDomainDetailPage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-xl font-bold text-slate-900 mb-6">도메인 상세정보</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Owner Info */}
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          <h2 className="text-base font-semibold text-slate-800 mb-4">소유자 정보</h2>
          <dl className="space-y-3">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6 lg:col-span-2">
          <h2 className="text-base font-semibold text-slate-800 mb-4">상태 및 SSL 설정</h2>
